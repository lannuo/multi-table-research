...
## 开源项目
- [APITable GitHub](https://github.com/apitable/apitable) — API导向低代码平台，最强开源Airtable替代
- [AITable.ai](https://aitable.ai/) — APITable商业版
- [NocoDB GitHub](https://github.com/nocodb/nocodb) — 10M+ Docker下载，连接已有SQL数据库
- [Baserow GitHub](https://github.com/Baserow/baserow) — 从零构建数据集
- [Univer GitHub](https://github.com/dream-num/univer) — AI原生电子表格引擎
- [HyperFormula GitHub](https://github.com/handsontable/hyperformula) — 400+公式的开源公式引擎
- [Yjs GitHub](https://github.com/yjs/yjs) — CRDT实时协作库
- [NocoDB生态评测](https://github.com/nocodb/nocodb/discussions/9009)
- [5个自托管Airtable替代品](https://www.nocobase.com/en/blog/5-self-hosted-airtable-alternatives)

## Notion 相关
- [The Data Model Behind Notion's Flexibility](https://www.notion.com/blog/data-model-behind-notion) — 官方博客，Block模型核心文章
...
- [Notion数据库扩展](https://medium.com/@nidhey60/how-notion-prepared-their-database-for-millions-of-users-dc198079e74c)
...
- [飞书多维表格+AI赋能](https://www.guancha.cn/economy/2025_11_11_796571.shtml)
- [一文读懂多维表格](https://www.feishu.cn/content/base)
- [飞书视图说明](https://www.feishu.cn/hc/zh-CN/articles/360049067931-)
...
## 技术架构
- [Baserow vs NocoDB - Softr](https://www.softr.io/blog/baserow-vs-nocodb)
...
## 数据存储
- [动态属性存储: Sparse Columns vs EAV vs JSONB](https://leapcell.io/blog/storing-dynamic-attributes-sparse-columns-eav-and-jsonb-explained) — 三种方案深度对比
...
- [APITable自动化队列文档](https://apitable.getoutline.com/s/751b142b-866f-4174-a5f1-a2975f85ad41/doc/automation-queue-9sy5d6zFgK)
...
- [在 PostgreSQL 使用中文全文搜索 - 掘金](https://juejin.cn/post/7282170455683301434)
- [PostgreSQL 全文检索深度指南 - 知乎](https://zhuanlan.zhihu.com/p/2025590075426088192)
- [pg_jieba 与 zhparser 方案解析 - 百度智能云](https://cloud.baidu.com/article/2827093)
- [PolarDB 全文检索功能 - 阿里云](https://help.aliyun.com/zh/polardb/polardb-for-postgresql/full-text-search-introduction/)
- [PostgreSQL 中文全文索引效率优化 - 掘金](https://juejin.cn/post/6844903548853960712)
- [Meilisearch 官方文档 - Tokenization](https://www.meilisearch.com/docs/learn/engine/language)
- [Meilisearch 排名系统深度解析](https://meilisearch.com/docs/resources/internals/ranking)
- [charabia - Meilisearch 分词库 (Rust)](https://github.com/meilisearch/charabia)
- [Meilisearch 中文文档站](https://meilisearch.com.cn/)
- [Meilisearch vs Elasticsearch - 腾讯云](https://cloud.tencent.com/developer/article/2440704)
...
- [meilisync - PG/MySQL/MongoDB → Meilisearch 同步](https://github.com/long2ice/meilisync)
- [Debezium PostgreSQL Connector](https://debezium.io/documentation/reference/1.9/connectors/postgresql.html)
- [PostgreSQL CDC with wal2json - OLake](https://olake.io/docs/connectors/postgres/wal2json_plugin)
- [PostgreSQL GIN 索引详解 - pganalyze](https://pganalyze.com/blog/gin-index)
- [PostgreSQL JSONB GIN 索引优化 - dev.to](https://dev.to/polliog/postgresql-jsonb-gin-indexes-why-your-queries-are-slow-and-how-to-fix-them-12a0)
- [ParadeDB pg_search BM25](https://docs.paradedb.com/legacy/indexing/tokenizers)
